              ...
              <tr key={e.id} className="hover:bg-gray-700/30 transition-colors group">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center justify-center gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                    <button onClick={() => openModal(e)} className="p-2 hover:bg-cyan-500/20 text-cyan-400 rounded-lg">
                      <Edit2 size={16} />
                    </button>
                    <button onClick={() => { if(confirm('Excluir?')) deleteExpense(e.id) }} className="p-2 hover:bg-red-500/20 text-red-400 rounded-lg">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </td>
