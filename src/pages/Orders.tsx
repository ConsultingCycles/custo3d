    ...
    <div className="space-y-6 pb-24 relative">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="text-gray-400 hover:text-white text-sm flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-700 hover:bg-gray-800 transition"
          >
                ...
                <div className="flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
                  ...
                  {!isShipped ? (
                    <>
                      ...
                      >
                        <CheckCircle size={18} /> <span className="hidden sm:inline">Efetivar Saída</span>
                      </button>
                    </>
                  ) : (
                    <div className="bg-gray-700 px-4 py-2 rounded-lg text-gray-400 flex items-center gap-2 cursor-default">
                      <CheckCircle size={18} /> Estoque Baixado
                    </div>
                  )}
                </div>
              </div>
      ...
      {selectedIds.length > 0 && (
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-cyan-900 text-white px-6 py-3 rounded-full shadow-2xl border border-cyan-500 flex items-center gap-6 z-50 animate-bounce-in">
          ...
          <button onClick={handlePrintSelection} className="flex items-center gap-2 hover:text-cyan-200 transition font-bold">
            <Printer size={20} /> Imprimir Ordem
          </button>
        </div>
      )}
    </div>
